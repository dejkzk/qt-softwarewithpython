    ...
    ui(new Ui::widget_back)
{
    ...
    plotGradient.setColorAt(0, QColor(17, 17, 17));
    ...
    axisRectGradient.setColorAt(0, QColor(17, 17, 17));
    ...
    plotGradient2.setColorAt(0, QColor(17, 17, 17));
    plotGradient2.setColorAt(1, QColor(17, 17, 17));
    ...
    axisRectGradient2.setColorAt(0, QColor(17, 17, 17));
    axisRectGradient2.setColorAt(1, QColor(17, 17, 17));
...
//    QChart_hall->axisY()->setRange(0, maxY);
...
void widget_back::timeToAddData()
{

}
void widget_back::timeToRePlot()
{
...
{
  alldata_flag=1;
  QMessageBox *m_box = new QMessageBox(QMessageBox::Information,QString("通知"),QString("Please waiting~~~"));
...
//               if(alldata_flag==1)
//               QMessageBox::about(this,"提示","loaded!");


                    //QThread::usleep(5000);//阻塞延时50us
...
void widget_back::on_pushButton_nextpage_clicked()
{
    ...
    {
    speed=1;
    QMessageBox::about(this,"亲","已经是最快了别点了");
    }
    qDebug()<<speed;
